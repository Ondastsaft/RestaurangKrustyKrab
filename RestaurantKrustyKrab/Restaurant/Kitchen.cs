...
namespace RestaurantKrustyKrab.Restaurant
{
    internal class Kitchen : RestaurantArea
    {
        ...
        public Kitchen(string name, int fromTop, int fromLeft) : base(name, fromTop, fromLeft)
        {
            ...
            Dishes.Add(1, new Dish("Wagyu", 500, 0, ""));
            Dishes.Add(2, new Dish("Pasta", 99, 0, ""));
            Dishes.Add(3, new Dish("Korv", 1000, 0, ""));
            Dishes.Add(4, new Dish("Fisk", 120, 0, ""));
            Dishes.Add(5, new Dish("Gryta", 120, 0, ""));
            Dishes.Add(6, new Dish("Soppa", 79, 0, ""));
            Dishes.Add(7, new Dish("Salad", 115, 0, ""));
