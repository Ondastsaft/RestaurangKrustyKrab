...
namespace RestaurantKrustyKrab.Restaurant
{
    internal class Kitchen : RestaurantArea
    {
        ...
        public Kitchen(string name, int fromTop, int fromLeft) : base(name, fromTop, fromLeft)
        {
            ...
            Dishes.Add(2, new Dish("Pasta Bolgonese", 500, 0, 0));
            Dishes.Add(3, new Dish("Hot Hund", 500, 0, 0));
            Dishes.Add(4, new Dish("Fisk o' Chips", 500, 0, 0));
            Dishes.Add(5, new Dish("Fisk grataine", 500, 0, 0));
            Dishes.Add(6, new Dish("Fisk sticks", 500, 0, 0));
            Dishes.Add(7, new Dish("Halloumi salad", 500, 0, 0));
            Dishes.Add(8, new Dish("Falafel", 500, 0, 0));
            Dishes.Add(9, new Dish("Wok", 500, 0, 0));
